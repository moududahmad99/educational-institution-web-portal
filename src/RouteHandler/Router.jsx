...
import NoticeDetails from "../pages/noticeDetails/NoticeDelails";
...
export const reactRouter = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<RootLayout />}>
      ...
      />
      <Route
        path="/administration/president-message"
        element={<PresidentMessage />}
      />
      <Route
        path="/administration/principal-message"
      ...
      <Route
        path="/admissions/admission-notice"
        element={<AdmissionNotice />}
      />
      <Route
        path="/admissions/admission-exam-syllabus"
        element={<AdmissionExamSyllabus />}
      />
      <Route
        path="/admissions/fill-admission-form"
        element={<FillAdmissionForm />}
      />
      <Route path="/admissions/admit-card" element={<AdmitCard />} />
      <Route
        path="/admissions/list-of-selected-students-seeking-admission"
        element={<SelectedStudents />}
      />
      <Route
        path="/admissions/list-of-selected-students-waiting-admission"
        element={<WaitingStudents />}
      />
