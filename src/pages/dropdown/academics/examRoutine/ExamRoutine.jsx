...
const ExamRoutine = () => {
  ...
  const tableRows = [
    { date: '10 - 1 - 2023', content: 'প্রাথমিক শিক্ষা পরীক্ষা রুটিন' },
    { date: '10 - 9 - 2015', content: 'মাধ্যমিক শিক্ষা পরীক্ষা রুটিন' },
    { date: '11 - 10 - 2013', content: 'উচ্চশিক্ষা পরীক্ষা রুটিন' },
    ...
    <React.Fragment>
      <div id="examRoutine">
        <div className="pages-title my-4 bg-gradient-to-r from-[rgba(244,254,255,1)] to-[rgba(161,182,182,1)] text-center flex flex-col items-center py-4">
          <h3 className='bg-[#79929C] text-lg font-medium my-2 text-white px-14 sm:px-14  py-2'>পরীক্ষার রুটিন</h3>
          <p className='text-md font-medium mt-2'>home / academics /<span className='text-red-800'> exam-routine</span></p>
        </div>
